    ...
    return (
        <Card className="flex  items-center border-b-2 p-1">
            <CardActionArea className="flex  items-center">
              <CardMedia className="w-20 h-20 rounded-full" title={'wycliffe'} image={'https://media-exp3.licdn.com/dms/image/C4D03AQFaYwtIZ5k53g/profile-displayphoto-shrink_800_800/0/1622195469007?e=1632355200&v=beta&t=24cvGNubyys3-JrSg5kB9FYqbRV4dOeGOH5T5MmdD-0'}/>
              <CardContent >
